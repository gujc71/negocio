...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-github-alt fa-fw"></i>결재문서확인</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
				...
				<div class="panel panel-default">
	                    <div class="panel-body">
	                    	<div class="row">
	                            ...
	                            <div class="col-lg-1"><c:out value="${sgnFormInfo.frmno}"/></div>
	                        </div>
	                    	<div class="row">
	                            <label class="col-lg-2">제목</label>
	                            <div class="col-lg-1"><c:out value="${sgnFormInfo.frmname}"/></div>
	                        </div>
	                        <div class="row">
	                            <label class="col-lg-2">설명</label>
	                            <div class="col-lg-1"><c:out value="${sgnFormInfo.frmdesc}"/></div>
	                        </div>
	                    	<div class="row">
	                            <label class="col-lg-2">내용</label>
	                            <div class="col-lg-5"><c:out value="${sgnFormInfo.frmcontents}"/></div>
	                        </div>
	                    </div>
                </div>
