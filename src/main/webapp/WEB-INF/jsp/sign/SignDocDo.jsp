        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            	<form id="form1" name="form1" role="form" action="adSignFormSave" method="post" onsubmit="return fn_formSubmit();" >
	                ...
	                <button class="btn btn-outline btn-primary">합의</button>
			        <button class="btn btn-outline btn-primary">결재</button>
			        <button class="btn btn-outline btn-primary">반려</button>
			        <button class="btn btn-outline btn-primary">목록</button>
