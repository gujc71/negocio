        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <%-- <s:message code="send.msg.sendtitle"/> --%>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
				...
				<c:if test='${boardInfo.userno==sessionScope.userno}' >
	                ...
	                <button id="boardReplyBtn" class="btn btn-outline btn-primary pull-right" onclick="fn_addBoardLike(<c:out value="${boardInfo.brdno}"/>)" ><i class="fa fa-thumbs-o-up fa-fw"></i> <s:message code="send.msg.reply"/></button>
				</c:if>
