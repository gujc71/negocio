...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-files-o fa-fw"></i><s:message code="survey.boardName"/></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="listHead">
                        <div class="listHiddenField pull-left field60"><s:message code="survey.no"/></div>
                        <div class="listHiddenField pull-right field100"><s:message code="survey.state"/></div>
                        <div class="listHiddenField pull-right field100"><s:message code="survey.writer"/></div>
                        <div class="listHiddenField pull-right field100"><s:message code="survey.date"/></div>
                        <div class="listHiddenField pull-right field200"><s:message code="survey.period"/></div>
                        <div class="listHiddenField pull-right field100"><s:message code="survey.questioncount"/></div>
                        <div class="listTitle"><s:message code="survey.title"/></div>
                    </div>
                    ...
                    <c:forEach var="listview" items="${listview }" varStatus="status">
						 <c:url var="link" value="SurveyRead">
                            <c:param name="surno" value="${listview.surno}" />
                        </c:url> 
                         ...
                         <div class="listBody">
                        	...
                        	<div class="listHiddenField pull-right field100 textCenter"><c:out value="${listview.questioncount}"/></div>
                         	 <div class="listTitle" title="<c:out value="${listview.surtitle}"/>">
                         	 	<a href="surveyRead?surno=<c:out value="${listview.surno}"/>">
                         	 		<c:out value="${listview.surtitle}"/>
                         	 	</a>
                            </div>
                         </div>
                    </c:forEach>
                        ...
                        <div class="form-group">
                            <div class="checkbox col-lg-3 pull-left">
                                 <label class="pull-right">
                                    <input type="checkbox" name="searchType" value="surcontent" <c:if test="${fn:indexOf(searchVO.searchType, 'surcontent')!=-1}">checked="checked"</c:if>/>
                                    <s:message code="board.contents"/>
                                </label>
                                 <label class="pull-right">
                                    <input type="checkbox" name="searchType" value="surtitle" <c:if test="${fn:indexOf(searchVO.searchType, 'surtitle')!=-1}">checked="checked"</c:if>/>
