...
<script>
	...
	function popupOpen(){
		var popUrl = "schedulePopup";	//팝업창에 출력될 페이지 URL
		var popOption = "width=370, height=360, resizable=no, scrollbars=no, status=no, directions=no, location=no, menubar=no, toolbar=no;";    //팝업창 옵션(optoin)
						...
						<div class="listBody">
							...
							<div class="listTitle" title="<c:out value="${listview.schtitle}"/>"><i class="fa fa-chevron-down"></i>
								...
								<i class="fa fa-chevron-up"></i>
									...
									<fmt:formatDate value="${listview.schstdt}" pattern="MM" />월&nbsp;<a href="javascript:popupOpen();" > <c:out value="${listview.schtitle}"/> </a><br>
								</div>
							</div>
						</div>
